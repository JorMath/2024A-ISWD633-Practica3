...
```
docker run -d --name client-postgres --publish 9500:80 -e PGADMIN_DEFAULT_PASSWORD=54321 -e PGADMIN_DEFAULT_EMAIL=jorman@example.com --network net-drupal dpage/pgadmin4
```
...
![image](https://github.com/JorMath/2024A-ISWD633-Practica3/assets/94020880/7199d394-4cd7-4bfc-8972-55d1c012b4e9)
